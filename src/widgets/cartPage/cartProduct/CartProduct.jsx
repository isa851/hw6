...
export const CartProduct = ({cartData, addCount, minCount, deleteCart}) => {
        ...
        <div className='cartBlock'>
                {
                    ...
                    cartData.map((prod) => (
                        ...
                        <div className='productDescription'>
                            ...
                            <h3 className='priceProduct'>${prod.price * prod.count}</h3>
                        </div>
                        <div className='productTotal'>
                            <svg onClick={() => {deleteCart(prod)}} width="18" height="20" viewBox="0 0 18 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <div className='total'> 
                                <button onClick={() => {minCount(prod)}}>-</button>
                                <span>{prod.count}</span>
                                <button onClick={() => {addCount(prod)}}>+</button>
                            </div>
                        </div>
                        </div>
                    ))
